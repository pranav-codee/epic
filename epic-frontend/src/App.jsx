...
import AdminAuditLog from "./portals/admin/AuditLog.jsx";
...
function Login() {
  ...
  return (
    <div style={{ maxWidth: 420, margin: "6rem auto", textAlign: "center" }}>
      <h1>EPIC</h1>
      <p className="muted">
        Enterprise Platform for Intelligent IT Collaboration
      </p>
      <button className="btn" onClick={login}>
        Sign in with Microsoft
      </button>
      <p className="muted" style={{ marginTop: 24 }}>
        You will authenticate via Microsoft Authenticator.
      </p>
    </div>
  );
}
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <RequireAuth>
              <RequireRole
                roles={["IT_ENGINEER", "IT_MANAGER", "SYSTEM_ADMIN"]}
              >
                <Shell area="admin">
                  <Routes>
                    ...
                    <Route
                      path="audit"
                      element={
                        <RequireRole roles={["IT_MANAGER", "SYSTEM_ADMIN"]}>
                          <AdminAuditLog />
                        </RequireRole>
                      }
                    />
