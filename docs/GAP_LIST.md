...
| G6 | SLA targets per priority (TBD-8) | Not implemented in v1 | SRS lists SLAs as TBD. Code has no SLA breach logic. To add later: extend Ticket with `sla_due_at`, populate in `create_ticket`, visualise on dashboard. |
